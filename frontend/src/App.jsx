...
function App() {
  ...
  return (
    <div className="relative w-full h-full flex items-start justify-center p-4 pb-24">
      <section className="fixed bottom-16 flex items-center justify-center bg-white/25 backdrop-blur-xs rounded-full px-6 py-4 gap-9 md:bottom-[calc((50vh-34rem)+4rem)]">
        {navItems.map((item) => (
